...
DATE_FORMAT(sn.delivery_date, '%d-%m-%Y') as delivery_date from `tabSerial No` sn ,`tabDelivery Note` dn where sn.delivery_document_type!="Null" and sn.delivery_document_type="Delivery Note"  and sn.delivery_document_no=dn.name   and dn.po_no='"""+po_no+"""' and  sn.delivery_document_no='"""+delivery_document_no+"""' and sn.customer='"""+customer+"""' """ ,  as_dict = 1)
...
DATE_FORMAT(sn.delivery_date, '%d-%m-%Y') as delivery_date from `tabSerial No` sn ,`tabDelivery Note` dn where sn.delivery_document_type!="Null" and sn.delivery_document_type="Delivery Note"  and sn.delivery_document_no=dn.name   and dn.po_no='"""+po_no+"""' and  sn.serial_no='"""+serial_no+"""' and sn.customer='"""+customer+"""' """ ,  as_dict = 1)
...
DATE_FORMAT(sn.delivery_date, '%d-%m-%Y') as delivery_date from `tabSerial No` sn ,`tabDelivery Note` dn where sn.delivery_document_type!="Null" and sn.delivery_document_type="Delivery Note"  and sn.delivery_document_no=dn.name   and dn.po_no='"""+po_no+"""' and sn.serial_no='"""+serial_no+"""' and  sn.delivery_document_no='"""+delivery_document_no+"""' and sn.customer='"""+customer+"""' """ ,  as_dict = 1)
...
DATE_FORMAT(sn.delivery_date, '%d-%m-%Y') as delivery_date from `tabSerial No` sn ,`tabDelivery Note` dn where sn.delivery_document_type!="Null" and sn.delivery_document_type="Delivery Note"  and sn.delivery_document_no=dn.name  and dn.po_no='"""+po_no+"""' and sn.customer='"""+customer+"""' """ ,  as_dict = 1)
	return po_no_list
...
DATE_FORMAT(sn.delivery_date, '%d-%m-%Y') as delivery_date from `tabSerial No` sn ,`tabDelivery Note` dn where sn.delivery_document_type!="Null" and sn.delivery_document_type="Delivery Note"  and sn.delivery_document_no=dn.name  and sn.delivery_document_no='"""+delivery_document_no+"""' and sn.customer='"""+customer+"""' """ ,  as_dict = 1)
...
DATE_FORMAT(sn.delivery_date, '%d-%m-%Y') as delivery_date from `tabSerial No` sn ,`tabDelivery Note` dn where sn.delivery_document_type!="Null" and sn.delivery_document_type="Delivery Note"  and sn.delivery_document_no=dn.name  and sn.serial_no='"""+serial_no+"""' and sn.customer='"""+customer+"""' """ ,  as_dict = 1)
