...
frappe.call({
    ...
    callback: function(r) {
        ...
        var tableBody = '<table width="100%" cellpadding="3" align="center" style="border-collapse:collapse;" border="1"><tr style="font-weight:bold;text-align:center;background-color: #8c8a8a;"><td ><label style="color:white;">Item Name</label></td><td ><label style="color:white;">Item Serial No</label></td><td style="padding-left: 2px;padding-right: 2px;"><label style="color:white;">COC</label></td><td ><label style="color:white;"><label style="color:white;">Pressure Test</label></td><td ><label style="color:white;">Build Sheet</label></td><td ><label style="color:white;">DNV-GL Product Certificate</label></td><td ><label style="color:white;">EU Declaration of Conformity</label></td><td style="padding-left: 2px;padding-right: 2px;"><label style="color:white;">Docpack</label></td><td ><label style="color:white;">Customer PO</label></td><td style="padding-left: 2px;padding-right: 2px;"><label style="color:white;">Delivery Note</label></td><td ><label style="color:white;">Delivery Note Date</label></td></tr>';

   all_data.forEach(function(d) {
                    console.log("all_data", d.po_no);

                    tableBody += '<tr><td style="text-align:left;padding-left: 4px;">' + d.item_name + '</td><td style="text-align:left;padding-left: 4px;">' + d.serial_no + '</td>' + ((d.pch_coc=="" || d.pch_coc==null) ? '<td></td>' : '<td style="text-align:center;">' + "<a href="+ d.pch_coc+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch_pressure_test=="" || d.pch_pressure_test==null) ? '<td></td>' : '<td style="text-align:center;">' + "<a href="+ d.pch_pressure_test+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch_build_sheet=="" || d.pch_build_sheet==null) ? '<td></td>' : '<td style="text-align:center;">' + "<a href="+ d.pch_build_sheet+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>"  + '</td>') + '' + ((d.pch_dnv_gl_product_certificate=="" || d.pch_dnv_gl_product_certificate==null) ? '<td></td>' : '<td style="text-align:center;">' + "<a href="+ d.pch_dnv_gl_product_certificate+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch_eu_declaration=="" || d.pch_eu_declaration==null) ? '<td></td>' : '<td style="text-align:center;">' + "<a href="+ d.pch_eu_declaration+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch1_combined_pdf=="" || d.pch1_combined_pdf==null) ? '<td></td>' : '<td style="text-align:center;">' + d.pch1_combined_pdf + '</td>') + '<td style="text-align:center;">' + d.po_no + '</td><td style="text-align:left;padding-left: 4px;">' + d.delivery_document_no + '</td><td style="text-align:center;">' + d.delivery_date + '</td></tr>';
        });
                tableBody += '<table>';

                // FINALLY ADD THE NEWLY CREATED TABLE WITH JSON DATA TO A CONTAINER.
                document.getElementById("totalrows").innerText = "Total No Of Rows:" + details.length;
