    ...
    callback: function(r) {
        ...
        var tableBody = '<table width="100%" cellpadding="3" align="center" style="border-collapse:collapse;border-color: lightgray;" border="1"><tr style="font-weight:bold;text-align:center;background-color: #8c8a8a;"><td style="color:white;">Item Name</td><td style="color:white;">Item Serial No</td><td style="color:white;">COC</td><td style="color:white;">Pressure Test</td><td style="color:white;">Build Sheet</td><td style="color:white;">DNV-GL Product Certificate</td><td style="color:white;">EU Declaration of Conformity</td><td style="color:white;">Docpack</td><td style="color:white;">Customer PO</td><td style="color:white;">Delivery Note</td><td style="color:white;">Delivery Note Date</td></tr>';
                ...
                all_data.forEach(function(d) {
                    ...
                    tableBody += '<tr><td style="text-align:left;border-color: lightgray;padding-left: 4px;">' + d.item_name + '</td><td style="text-align:left;border-color: lightgray;padding-left: 4px;">' + d.serial_no + '</td>' + ((d.pch_coc=="" || d.pch_coc==null) ? '<td></td>' : '<td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_coc+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch_pressure_test=="" || d.pch_pressure_test==null) ? '<td></td>' : '<td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_pressure_test+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch_build_sheet=="" || d.pch_build_sheet==null) ? '<td></td>' : '<td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_build_sheet+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>"  + '</td>') + '' + ((d.pch_dnv_gl_product_certificate=="" || d.pch_dnv_gl_product_certificate==null) ? '<td></td>' : '<td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_dnv_gl_product_certificate+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch_eu_declaration=="" || d.pch_eu_declaration==null) ? '<td></td>' : '<td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_eu_declaration+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td>') + '' + ((d.pch1_combined_pdf=="" || d.pch1_combined_pdf==null) ? '<td></td>' : '<td style="text-align:center;border-color: lightgray;">' + d.pch1_combined_pdf + '</td>') + '<td style="text-align:center;border-color: lightgray;">' + d.po_no + '</td><td style="text-align:left;border-color: lightgray;padding-left: 4px;">' + d.delivery_document_no + '</td><td style="text-align:center;border-color: lightgray;">' + d.delivery_date + '</td></tr>';
        });
                tableBody += '<table>';
