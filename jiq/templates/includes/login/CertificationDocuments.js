...
frappe.call({
    ...
    callback: function(r) {
	    ...
	    if(d.pch_coc=="" || d.pch_coc==null){d.pch_coc="TBU" }
            if(d.pch_pressure_test=="" || d.pch_pressure_test==null){d.pch_pressure_test="TBU" }
            if(d.pch_build_sheet=="" || d.pch_build_sheet==null){d.pch_build_sheet="TBU" }
            if(d.pch_eu_declaration_of_conformity=="" || d.pch_eu_declaration_of_conformity==null){d.pch_eu_declaration_of_conformity="TBU" }
            if(d.pch_dnv_gl_product_certificate=="" || d.pch_dnv_gl_product_certificate==null){d.pch_dnv_gl_product_certificate="TBU" }
	    if(d.pch1_combined_pdf=="" || d.pch1_combined_pdf==null){d.pch1_combined_pdf="TBU" }
            if(d.po_no=="" || d.po_no==null){d.po_no="TBU" }
            tableBody += '<tr><td style="text-align:left;border-color: lightgray;padding-left: 4px;">' + d.item_name + '</td><td style="text-align:left;border-color: lightgray;padding-left: 4px;">' + d.serial_no + '</td><td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_coc+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td><td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_pressure_test+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td><td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_build_sheet+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>"  + '</td><td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_dnv_gl_product_certificate+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td><td style="text-align:center;border-color: lightgray;">' + "<a href="+ d.pch_eu_declaration+" " + "target='_blank'><img src='/files/pdf.jpg'  width='25' height='25'></a>" + '</td><td style="text-align:center;border-color: lightgray;">' + d.pch1_combined_pdf + '</td><td style="text-align:center;border-color: lightgray;">' + d.po_no + '</td><td style="text-align:left;border-color: lightgray;padding-left: 4px;">' + d.delivery_document_no + '</td><td style="text-align:center;border-color: lightgray;">' + d.delivery_date + '</td></tr>';
        });
        tableBody += '<table>';
