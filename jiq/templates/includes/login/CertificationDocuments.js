...
frappe.call({
    ...
    method: "frappe.www.testreport.api_user",
...
function get_value_of_data(delivery_document_no, serial_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.delivery_serial",
        args: {
...
function get_value_of_po_delivery(po_no, delivery_document_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.po_delivery",
        args: {
            "delivery_document_no": delivery_document_no,
            "po_no": po_no
        },
...
function get_value_of_po_serial(po_no, serial_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.po_serial",
        args: {
            "serial_no": serial_no,
            "po_no": po_no
        },
...
function get_value_of_all_filters(po_no, delivery_document_no, serial_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.all_filters_applied",
        args: {
            "po_no": po_no,
            "delivery_document_no": delivery_document_no,
            "serial_no": serial_no
...
function get_po_no(po_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.po_no",
        args: {
            "po_no": po_no
        },
        async: false,
...
function get_delivery_document_no(delivery_document_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.delivery_document_no",
        args: {
            "delivery_document_no": delivery_document_no
        },
        async: false,
...
function get_serial_no(serial_no) {
    ...
    frappe.call({
        ...
        method: "frappe.www.testreport.serial_no",
        args: {
            "serial_no": serial_no
        },
        async: false,
