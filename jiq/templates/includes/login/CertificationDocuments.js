...
frappe.call({
    ...
    callback: function(r) {
        ...
        all_data.forEach(function(d) {
            tableBody +=
 '<tr><td style="text-align:left;border-color: lightgray;padding-left: 3px;">' + d.item_name + '</td><td style="text-align:left;border-color: lightgray;padding-left: 3px;">' + d.serial_no + '</td>('+d.pch1_coc+' !== "null" ? <td style="text-align:center;border-color: lightgray;">' + d.pch1_coc + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>') 
(d.pch1_pressure_test !== "null" ? '<td style="text-align:center;border-color: lightgray;">' + d.pch1_pressure_test + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>') 
(d.pch1_build_sheet !== "null" ? '<td style="text-align:center;border-color: lightgray;">' + d.pch1_build_sheet + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>') 
(d.pch1_dnv_gl_product_certificate !== "null" ? '<td style="text-align:center;border-color: lightgray;">' + d.pch1_dnv_gl_product_certificate + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>') 
(d.pch1_eu_declaration_of_conformity !== "null" ? '<td style="text-align:center;border-color: lightgray;">' + d.pch1_eu_declaration_of_conformity + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>') 
(d.pch1_combined_pdf !== "null" ? '<td style="text-align:center;border-color: lightgray;">' + d.pch1_combined_pdf + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>')(d.po_no !== "null" ? '<td style="text-align:center;border-color: lightgray;">' + d.po_no + '</td>' : '<td style="text-align:center;border-color: lightgray;">' + "tdu" + '</td>')<td style="text-align:left;border-color: lightgray;padding-left: 3px;">' + d.delivery_document_no + '</td><td style="text-align:center;border-color: lightgray;">' + d.delivery_date + '</td></tr>';
});
        tableBody += '<table>';
